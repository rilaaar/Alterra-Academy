...
public class ProductStep {
    ...
    @When("I set {string} name product {string} description product {string} price product {string} categories product")
    public void iSetNameProductDescriptionProductPriceProductCategoriesProduct(String nameproduct, String descriptionproduct, String priceproduct, String categoriesproduct) {
