...
Mobile.tap(findTestObject('Object Repository/Kode Referral/android.view.View'), 0)

Mobile.tap(findTestObject('Object Repository/Kode Referral/android.view.View (1)'), 0)

Mobile.tap(findTestObject('Object Repository/Kode Referral/android.view.View (2)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Kode Referral/android.view.View'), 0)
