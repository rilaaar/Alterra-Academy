...
Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText - Konfirmasi kata sandi'), 'Windows11', 
    0)
...
Mobile.tap(findTestObject('Object Repository/Register/android.view.View (5)'), 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText'), '1', 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText (1)'), '2', 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText (2)'), '3', 0)

Mobile.setText(findTestObject('Object Repository/Register/android.widget.EditText (3)'), '4', 0)

Mobile.tap(findTestObject('Object Repository/Register/android.view.View (6)'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/Register/android.view.View (7)'), 0)
