...
Mobile.setText(findTestObject('Object Repository/Register/android.widget.ImageView - Masukan email'), 'sarah@gmail.om', 
    0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/Register/android.view.View (9)'), 0)
